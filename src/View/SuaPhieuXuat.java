 ...
 * @author Lo Dai Luc
 */
public class SuaPhieuXuat extends javax.swing.JDialog implements View {
    ...
    public SuaPhieuXuat(javax.swing.JPanel parent, java.awt.Frame owner, boolean modal, Phieu phieu) {
        super(owner, modal);
        initComponents();
        this.parent = (PhieuXuatView) parent;
        this.setLocationRelativeTo(null);

        listCTP =  new ArrayList<>(phieu.getCTPhieu());
    ...
    private SuaPhieuXuat(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        btnLuuThayDoi.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        jLabel2.setText("SỬA PHIẾU XUẤT");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel5.setText("MÃ PHIẾU:");

        txtMaPhieu.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtMaPhieu, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(23, 23, 23))
        );
    ...
    private void btnLuuThayDoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuThayDoiActionPerformed
        ...
        try {
            ...
            for (ChiTietPhieu cTP : listCTP) {
                cTP.setMaPhieu(phieuXuat.getMaPhieu());
            }
     
            int confirm = JOptionPane.showConfirmDialog(null, "Bạn có chắc chắn muốn lưu thay đổi ?", "Xác nhận xóa", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.NO_OPTION) {
                this.dispose();
                return;
            }
            phieuXuat.setCTPhieu(listCTP);
            phieuXuat.setTongThanhToan(tongThanhToan);
            
            XuatHangCtrl.updateFile();
            this.dispose();
            JOptionPane.showMessageDialog(null, "phiếu đã được sửa thành công.");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage(), "Lỗi", JOptionPane.ERROR_MESSAGE);
        }
