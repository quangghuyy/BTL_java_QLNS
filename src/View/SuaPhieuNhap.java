 ...
 * @author Lo Dai Luc
 */
public class SuaPhieuNhap extends javax.swing.JDialog implements View {
    ...
    public SuaPhieuNhap(javax.swing.JPanel parent, java.awt.Frame owner, boolean modal, Phieu phieu) {
        super(owner, modal);
        initComponents();
        ...
        this.phieuNhap = (PhieuNhap) phieu;

        txtMaPhieu.setText(phieuNhap.getMaPhieu());
        cboNhaCungCap.setSelectedItem(phieuNhap.getNhaCungCap());
    ...
    private SuaPhieuNhap(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("SỬA PHIẾU NHẬP");
    ...
    private void btnLuuThayDoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuThayDoiActionPerformed
        ...
        try {
            ...
            for (ChiTietPhieu cTP : listCTP) {
                cTP.setMaPhieu(phieuNhap.getMaPhieu());
            }
